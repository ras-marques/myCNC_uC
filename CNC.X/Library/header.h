...
extern int probing;
extern long int x_start_probe;
extern long int y_start_probe;
extern long int z_start_probe;
extern long int x_end_probe;
extern long int y_end_probe;
extern long int z_end_probe;
extern int gridsize;
void probe(void);
void execute(void);
